...
; The player's priority value will be stored in register c and the enemy's priority value will be stored in register e.
...
; wd033-wd034 contain pointer to pic
	...
	ld a, [wLinkState]
	and a
	ld a, BANK("Pics 10") ; this is where all the trainer pics are (not counting Red's)
	jr z, .loadSprite
